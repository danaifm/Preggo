...
class newPregnancyInfo extends StatefulWidget {
  //const SignUp({Key? key}) : super(key: key);
  late final String userId;
  @override
  State<StatefulWidget> createState() {
    return _fillNewPregnancyInfo();
  }
}

class _fillNewPregnancyInfo extends State<newPregnancyInfo> {
